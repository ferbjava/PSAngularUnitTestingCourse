...
describe('HeroesComponent (deep tests)', () => {
  ...
  it('should render as a HeroComponent', () => {
    mockHeroService.getHeroes.and.returnValue(of(HEROES));

    // run ngOnInit()
    fixture.detectChanges();
    
    let heroComponentsDEs = fixture.debugElement.queryAll(By.directive(HeroComponent));
  ...
  it(`should call heroService.deleteHero when the Hero Component's 
    delete button is clicked: use direct call to the child method`, () => {
  ...
  it(`should call heroService.deleteHero when the Hero Component's 
    delete button is clicked: trigger event to the parent`, () => {
    spyOn(fixture.componentInstance, 'delete');
    mockHeroService.getHeroes.and.returnValue(of(HEROES));
